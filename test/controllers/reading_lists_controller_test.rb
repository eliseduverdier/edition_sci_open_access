...
class ReadingListsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reading_list" do
    assert_difference('ReadingList.count') do
      post reading_lists_url, params: { reading_list: { paper_id: @reading_list.paper_id, person_id: @reading_list.person_id, reading_list_folder_id: @reading_list.reading_list_folder_id } }
    end
  ...
  test "should update reading_list" do
    patch reading_list_url(@reading_list), params: { reading_list: { paper_id: @reading_list.paper_id, person_id: @reading_list.person_id, reading_list_folder_id: @reading_list.reading_list_folder_id } }
